...
def get_all_sites() -> List[Dict]:
    ...
    return db.fetchall("SELECT site_id, site_name, address FROM Sites ORDER BY site_name")
...
def get_all_departments() -> List[Dict]:
    ...
    return db.fetchall("SELECT department_id, name FROM Departments ORDER BY name")
